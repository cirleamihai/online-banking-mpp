        ...
        <>
            ...
            <div style={{margin: "5rem"}}>
                ...
                <div className="d-flex justify-content-center align-items-center">
                    {repo.getCrudPerms() && (
                        <Link className="w-100 d-flex justify-content-center" to="/card/add">
                            <Button size="lg" className="submit-btn">Add Card</Button>
                        </Link>
                    )}
                    <Link className="w-100 d-flex justify-content-center" to="/view/chart/">
                        <Button size="lg" className="submit-btn">View Chart</Button>
                    </Link>
                </div>
            </div>
        </>
